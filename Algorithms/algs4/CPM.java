 ...
 *  from the job-scheduling problem specification, as prescribed
 *  by the critical path method, then uses {@link AcyclicLP}
 *  to find the longest-paths tree and to print the longest-paths
